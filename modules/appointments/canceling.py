...
@tool
def cancel_appointment(context: ToolContext, doctor_name: str, scheduled_date: Annotated[datetime, ToolParameterOptions(
    description="Need the date and time for rescheduling")], reason: str) -> ToolResult:
